...
export namespace GitHubAppInstallationByOwner {
  ...
  export type Query = {
    ...
    GitHubAppInstallation?: Maybe<(Maybe<GitHubAppInstallation>)[]>;
  };
...
export namespace ScmProviderById {
  ...
  export type Query = {
    ...
    SCMProvider?: Maybe<(Maybe<ScmProvider>)[]>;
  };
...
export namespace OnGitHubAppInstallation {
  ...
  export type GitHubAppResourceProvider = {
...
export namespace OnPullRequest {
  ...
  export type Subscription = {
    ...
    PullRequest?: Maybe<(Maybe<PullRequest>)[]>;
  };
